...
const UxIcon = class {
    ...
    render() {
        if (!this.name) {
            return index.h("div", { class: "icon-placeholder" }, "?");
        }
        const path = this.getIconPath(this.name);
        const sizeClass = this.getSizeClass();
        return (index.h("svg", { class: `ux-icon ${sizeClass}`, fill: "none", stroke: this.color, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: path })));
    }
};
UxIcon.style = uxIconCss;

exports.ux_icon = UxIcon;
//# sourceMappingURL=ux-icon.entry.cjs.js.map
