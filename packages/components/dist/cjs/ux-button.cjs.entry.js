...
const UxButton = class {
    ...
    render() {
        ...
        return (index.h("button", { key: 'd1b71a014f25295502781635a8fc2107889fe47a', class: classes, disabled: this.disabled || this.loading, onClick: this.handleClick }, this.loading && index.h("span", { key: 'e4ea6511e2df5b6f7349d1acb0bde3d19d2c179b', class: "spinner" }), index.h("span", { key: '11a6287560a1a9c2918b8e7681cd5adf7f45eea4', class: "button-content" }, index.h("slot", { key: '272db15e7085d1f60e475cdbed61f32bab30eb7c' }))));
    }
};
UxButton.style = uxButtonCss;

exports.ux_button = UxButton;
//# sourceMappingURL=ux-button.entry.cjs.js.map
