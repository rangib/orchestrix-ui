...
const NAMESPACE = 'orchestrix-components';
const BUILD = /* orchestrix-components */ { hydratedSelectorName: "hydrated", slotRelocation: true, updatable: true, watchCallback: false };
...
class UxButton {
    ...
    render() {
        ...
        return (hAsync("button", { key: 'd1b71a014f25295502781635a8fc2107889fe47a', class: classes, disabled: this.disabled || this.loading, onClick: this.handleClick }, this.loading && hAsync("span", { key: 'e4ea6511e2df5b6f7349d1acb0bde3d19d2c179b', class: "spinner" }), hAsync("span", { key: '11a6287560a1a9c2918b8e7681cd5adf7f45eea4', class: "button-content" }, hAsync("slot", { key: '272db15e7085d1f60e475cdbed61f32bab30eb7c' }))));
    }
    static get style() { return uxButtonCss; }
...
class UxCard {
    ...
    render() {
        ...
        return (hAsync("div", { key: '058c07b988435135f61b727c4255732071a87b91', class: classes }, hAsync("div", { key: '3519d47d0b804a95f571d331c8c2691f4edccf41', class: "card-header" }, hAsync("slot", { key: 'e4d266a7e2921234971f1a0903e4620b6a8f2715', name: "header" })), hAsync("div", { key: 'ec477c533b4d17e24d56dfe80bab37b7719954a0', class: "card-body" }, hAsync("slot", { key: '7bcba9fefd435c5b013aa7471d5b126b26326293' })), hAsync("div", { key: 'ec14d65278f3f1ea45fa7b28c6f71e746071285e', class: "card-footer" }, hAsync("slot", { key: '612c94e71f6f69ddf1251868df3b179956ad05f5', name: "footer" }))));
    }
    static get style() { return uxCardCss; }
    static get cmpMeta() { return {
        "$flags$": 265,
        "$tagName$": "ux-card",
        "$members$": {
...
class UxIcon {
    ...
    render() {
        ...
        return (hAsync("svg", { class: `ux-icon ${sizeClass}`, fill: "none", stroke: this.color, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" }, hAsync("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: path })));
    }
    static get style() { return uxIconCss; }
    static get cmpMeta() { return {
        "$flags$": 265,
        "$tagName$": "ux-icon",
        "$members$": {
...
class UxInput {
    ...
    render() {
        return (hAsync("div", { key: '93dc3dd7ff0bc29489bd6f737dcb8182aa9b6878', class: "input-container" }, this.label && (hAsync("label", { key: 'e4e0af12f398c1bee513a5f471f31494bf1533e1', class: "input-label" }, this.label, this.required && hAsync("span", { key: '7ddf3d0035ea6ecd0619dfe6d7ab2ba892ce2d49', class: "required" }, "*"))), hAsync("input", { key: '2fe0a47ff9e856976fdbf801818329988fd05fe4', class: "ux-input", type: this.type, placeholder: this.placeholder, value: this.value, disabled: this.disabled, required: this.required, onInput: this.handleInput, onBlur: this.handleBlur, onFocus: this.handleFocus })));
    }
    static get style() { return uxInputCss; }
    static get cmpMeta() { return {
        "$flags$": 265,
        "$tagName$": "ux-input",
        "$members$": {
